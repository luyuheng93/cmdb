...
class SecrityDevice(models.Model):
    """  安全设备  """
    sub_asset_type_choice = (
        (0, '防火墙'),
        (1, '入侵检测设备'),
...
class Software(models.Model):
    ...
    version = models.CharField(max_length=64, unique=True, help_text='例如： Centos release 6.7 (Final)', verbose_name='软件/系统版本')
...
class Contract(models.Model):
    ...
    memo = models.CharField('备注', blank=True, null=True)
...
class CPU(models.Model):
    ...
    cpu_count = models.PositiveIntegerField('物理CPU个数', default=1)
    cpu_core_count = models.PositiveIntegerField('CPU核数', default=1)
...
class NIC(models.Model):
    ...
    asset = models.ForeignKey('Asset')
    mame = models.CharField('网卡名称', max_length=64, blank=True, null=True)
...
class EventLog(models.Model):
    ...
    mome = models.TextField('备注', blank=True, null=True)
